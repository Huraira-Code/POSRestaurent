...
import { FaEye, FaEyeSlash, FaUserShield, FaLock, FaEnvelope, FaCheckCircle, FaExclamationCircle, FaTimes } from 'react-icons/fa';
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log('Submitting login data:', { ...formData, password: '***masked***' });
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[#a0a0a0] text-xs leading-relaxed">
                  This is a restricted area for authorized super administrators only. 
