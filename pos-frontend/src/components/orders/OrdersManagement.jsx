...
import {
  ...
  printDailySalesReportAndCloseDay, // 🆕 Import the new function
} from "../../https/index";
                ...
                {displayedOrders.map((order) => (
                  <tr key={order._id} className="hover:bg-[#222222]">
                    ...
                    <td className="px-6 py-4">
                      <div className="text-sm text-[#a0a0a0] max-w-xs truncate">
            ...
            <div className="px-6 py-4 border-t border-[#2a2a2a] flex items-center justify-between">
              <div className="text-sm text-[#606060]">
                ...
                <span className="font-medium">
                  {Math.min(displayedOrders.length, displayedOrdersCount)}
                </span>{" "}
