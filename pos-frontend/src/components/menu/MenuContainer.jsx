        ...
        {categoriesData.map((category) => {
          ...
          return (
            <div key={categoryId} className="w-full" id={categoryId}>
              {/* Category Header */}
              <div
                className="flex flex-col items-start justify-between p-3 md:p-4 rounded-lg h-[80px] sm:h-[90px] md:h-[100px] cursor-pointer transition-transform hover:scale-105 mb-4"
                style={{ backgroundColor: category.bgColor || "#2a2a2a" }}
